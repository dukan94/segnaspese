...
/// Saldo reale: somma di tutti i movimenti (entrate positive, uscite
/// negative), da sempre.
final realBalanceProvider = Provider<AsyncValue<double>>((ref) {
  final transactions = ref.watch(allTransactionsProvider);
  return transactions.whenData(
    (list) => list.fold<double>(0, (sum, t) => sum + t.signedAmount),
  );
});
